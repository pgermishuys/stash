...
#[cfg(test)]
mod tests {
    use crate::core::utils::convert_dotnet_guid;
    use std::convert::TryInto;
    use uuid::Uuid;

    #[test]
    fn can_convert_dotnet_guid(){
        //expected: 050d9d21-717a-40f5-9037-d455c6af0ebc
        let expected = Uuid::parse_str("050d9d21-717a-40f5-9037-d455c6af0ebc").unwrap();
        let dotnet_uuid: [u8; 16] = [33, 157, 13, 5, 122, 113, 245, 64, 144, 55, 212, 85, 198, 175, 14, 188];
